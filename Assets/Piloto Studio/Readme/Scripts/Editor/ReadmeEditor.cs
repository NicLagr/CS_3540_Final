...
namespace ReadmeSystem.Editor
{
    ...
    public class ReadmeEditor : UnityEditor.Editor
    {
        ...
        string nextReadmeTitle
        {
            get
            {
                if (readme.nextReadme == null)
                    return "Next";
                return string.IsNullOrEmpty(readme.nextReadme.title) ? "Next" : readme.nextReadme.title;
            }
        }
        ...
        string prevReadmeTitle
        {
            get
            {
                if (readme.prevReadme == null)
                    return "Prev";
                return string.IsNullOrEmpty(readme.prevReadme.title) ? "Prev" : readme.prevReadme.title;
            }
        }
        ...
        {
            var result = GetAllRootReadme().FirstOrDefault();
            if (result != null)
            {
                ResetAllRootReadme();
                result.isRoot = true;
        ...
        {
            foreach (var readme in GetAllRootReadme())
            {
                readme.isRoot = false;
            }
        }
